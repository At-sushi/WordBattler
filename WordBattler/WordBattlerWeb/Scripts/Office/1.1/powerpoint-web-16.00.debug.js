...
Microsoft.Office.Common.ServiceEndPoint.prototype = {
    ...
    registerConversation: function Microsoft_Office_Common_ServiceEndPoint$registerConversation(conversationId, conversationUrl) {
        ...
        Sys.Debug.trace("osfclient\\web\\jscript\\officexdm.ts" + ":" + 310 + "|" + ("registerConversation: cId=" + conversationId + " Url=" + conversationUrl));
...
Microsoft.Office.Common.XdmCommunicationManager = (function () {
    ...
    function _checkOrigin(url, origin) {
        if(url.length > origin.length && origin.slice(-1) != '/') {
            origin += "/";
        }
        return (0 == url.indexOf(origin));
    }
    function _receive(e) {
        if(e.data != '') {
            var messageObject;
            ...
            if(messageObject._messageType === Microsoft.Office.Common.MessageType.request) {
                ...
                try  {
                    ...
                    Sys.Debug.trace("osfclient\\web\\jscript\\officexdm.ts" + ":" + 791 + "|" + ("_receive: request, origin=" + requesterUrl + " sourceURL:" + serviceEndPoint._conversations[messageObject._conversationId]));
                ...
                Sys.Debug.trace("osfclient\\web\\jscript\\officexdm.ts" + ":" + 847 + "|" + ("_receive: response, origin=" + e.origin + " targetURL:" + clientEndPoint._targetUrl));
...
Microsoft.Office.Common.ResponseSender = function Microsoft_Office_Common_ResponseSender(requesterWindow, requesterUrl, actionName, conversationId, correlationId, responseType) {
    ...
    this._send = function (result) {
        ...
        Sys.Debug.trace("osfclient\\web\\jscript\\officexdm.ts" + ":" + 1213 + "|" + ("_send: requestUrl=" + me._requesterUrl + " _actionName:" + me._actionName));
    };
};
    ...
    fromHost: [
        {
            ...
            value: Microsoft.Office.WebExtension.Parameters.Data
        }
    ]
});
...
(function (OSF_DDA_Marshaling_GoToType) {
    OSF_DDA_Marshaling_GoToType._map = [];
    OSF_DDA_Marshaling_GoToType.Binding = 0;
    OSF_DDA_Marshaling_GoToType.NamedItem = 1;
    OSF_DDA_Marshaling_GoToType.Slide = 2;
    OSF_DDA_Marshaling_GoToType.Index = 3;
...
(function (OSF_DDA_Marshaling_SelectionMode) {
    OSF_DDA_Marshaling_SelectionMode._map = [];
    OSF_DDA_Marshaling_SelectionMode.Default = 0;
    OSF_DDA_Marshaling_SelectionMode.Selected = 1;
    OSF_DDA_Marshaling_SelectionMode.None = 2;
...
OSF.DDA.WAC.Delegate.ParameterMap.define({
    ...
    toHost: [
        {
            name: Microsoft.Office.WebExtension.Parameters.Id,
            value: OSF.DDA.Marshaling.NavigationKeys.Id
        }, 
        {
            name: Microsoft.Office.WebExtension.Parameters.GoToType,
            value: OSF.DDA.Marshaling.NavigationKeys.GoToType
        }, 
        {
            name: Microsoft.Office.WebExtension.Parameters.SelectionMode,
            value: OSF.DDA.Marshaling.NavigationKeys.SelectionMode
        }
    ]
});
OSF.DDA.WAC.Delegate.ParameterMap.define({
    ...
    toHost: [
        {
            ...
            value: OSF.DDA.Marshaling.GoToType.Binding
        }, 
        {
            name: Microsoft.Office.WebExtension.GoToType.NamedItem,
            value: OSF.DDA.Marshaling.GoToType.NamedItem
        }, 
        {
            name: Microsoft.Office.WebExtension.GoToType.Slide,
            value: OSF.DDA.Marshaling.GoToType.Slide
        }, 
        {
            name: Microsoft.Office.WebExtension.GoToType.Index,
            value: OSF.DDA.Marshaling.GoToType.Index
        }
    ]
});
OSF.DDA.WAC.Delegate.ParameterMap.define({
    ...
    toHost: [
        {
            ...
            value: OSF.DDA.Marshaling.SelectionMode.Default
        }, 
        {
            name: Microsoft.Office.WebExtension.SelectionMode.Selected,
            value: OSF.DDA.Marshaling.SelectionMode.Selected
        }, 
        {
            name: Microsoft.Office.WebExtension.SelectionMode.None,
            value: OSF.DDA.Marshaling.SelectionMode.None
        }
    ]
});
OSF.DDA.WAC.Delegate.ParameterMap.define({
    ...
    toHost: [
        {
            name: OSF.DDA.Marshaling.NavigationKeys.NavigationRequest,
            value: OSF.DDA.WAC.Delegate.ParameterMap.self
        }
    ]
});
...
(function (OSF_DDA_Marshaling_FilePropertiesKeys) {
    OSF_DDA_Marshaling_FilePropertiesKeys._map = [];
    OSF_DDA_Marshaling_FilePropertiesKeys.Properties = 0;
    OSF_DDA_Marshaling_FilePropertiesKeys.Url = 1;
    ...
    fromHost: [
        {
            ...
            value: OSF.DDA.Marshaling.FilePropertiesKeys.Url
        }
    ]
});
OSF.DDA.WAC.Delegate.ParameterMap.define({
    ...
    fromHost: [
        {
            name: OSF.DDA.PropertyDescriptors.FilePropertiesDescriptor,
            value: OSF.DDA.Marshaling.FilePropertiesKeys.Properties
        }
    ]
});
OSF.DDA.AsyncMethodNames.addNames({
...
var OSF_DDA_Theming_InternalThemeHandler = (function () {
    ...
    OSF_DDA_Theming_InternalThemeHandler.prototype._changeDocumentThemeData = function (data) {
        var documentThemeCssMapping = [
            {
                name: "primaryFontColor",
                cssSelector: ".office-docTheme-primary-fontColor",
                cssProperty: "color"
            }, 
            {
                name: "primaryBackgroundColor",
                cssSelector: ".office-docTheme-primary-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "secondaryFontColor",
                cssSelector: ".office-docTheme-secondary-fontColor",
                cssProperty: "color"
            }, 
            {
                name: "secondaryBackgroundColor",
                cssSelector: ".office-docTheme-secondary-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "accent1",
                cssSelector: ".office-contentAccent1-color",
                cssProperty: "color"
            }, 
            {
                name: "accent2",
                cssSelector: ".office-contentAccent2-color",
                cssProperty: "color"
            }, 
            {
                name: "accent3",
                cssSelector: ".office-contentAccent3-color",
                cssProperty: "color"
            }, 
            {
                name: "accent4",
                cssSelector: ".office-contentAccent4-color",
                cssProperty: "color"
            }, 
            {
                name: "accent5",
                cssSelector: ".office-contentAccent5-color",
                cssProperty: "color"
            }, 
            {
                name: "accent6",
                cssSelector: ".office-contentAccent6-color",
                cssProperty: "color"
            }, 
            {
                name: "accent1",
                cssSelector: ".office-contentAccent1-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "accent2",
                cssSelector: ".office-contentAccent2-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "accent3",
                cssSelector: ".office-contentAccent3-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "accent4",
                cssSelector: ".office-contentAccent4-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "accent5",
                cssSelector: ".office-contentAccent5-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "accent6",
                cssSelector: ".office-contentAccent6-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "accent1",
                cssSelector: ".office-contentAccent1-borderColor",
                cssProperty: "border-color"
            }, 
            {
                name: "accent2",
                cssSelector: ".office-contentAccent2-borderColor",
                cssProperty: "border-color"
            }, 
            {
                name: "accent3",
                cssSelector: ".office-contentAccent3-borderColor",
                cssProperty: "border-color"
            }, 
            {
                name: "accent4",
                cssSelector: ".office-contentAccent4-borderColor",
                cssProperty: "border-color"
            }, 
            {
                name: "accent5",
                cssSelector: ".office-contentAccent5-borderColor",
                cssProperty: "border-color"
            }, 
            {
                name: "accent6",
                cssSelector: ".office-contentAccent6-borderColor",
                cssProperty: "border-color"
            }, 
            {
                name: "hyperlink",
                cssSelector: ".office-a",
                cssProperty: "color"
            }, 
            {
                name: "followedHyperlink",
                cssSelector: ".office-a:visited",
                cssProperty: "color"
            }, 
            {
                name: "headerLatinFont",
                cssSelector: ".office-headerFont-latin",
                cssProperty: "font-family"
            }, 
            {
                name: "headerEastAsianFont",
                cssSelector: ".office-headerFont-eastAsian",
                cssProperty: "font-family"
            }, 
            {
                name: "headerScriptFont",
                cssSelector: ".office-headerFont-script",
                cssProperty: "font-family"
            }, 
            {
                name: "headerLocalizedFont",
                cssSelector: ".office-headerFont-localized",
                cssProperty: "font-family"
            }, 
            {
                name: "bodyLatinFont",
                cssSelector: ".office-bodyFont-latin",
                cssProperty: "font-family"
            }, 
            {
                name: "bodyEastAsianFont",
                cssSelector: ".office-bodyFont-eastAsian",
                cssProperty: "font-family"
            }, 
            {
                name: "bodyScriptFont",
                cssSelector: ".office-bodyFont-script",
                cssProperty: "font-family"
            }, 
            {
                name: "bodyLocalizedFont",
                cssSelector: ".office-bodyFont-localized",
                cssProperty: "font-family"
            }
        ];
    ...
    OSF_DDA_Theming_InternalThemeHandler.prototype._changeOfficeThemeData = function (data) {
        var officeThemeCssMapping = [
            {
                name: "primaryFontColor",
                cssSelector: ".office-officeTheme-primary-fontColor",
                cssProperty: "color"
            }, 
            {
                name: "primaryBackgroundColor",
                cssSelector: ".office-officeTheme-primary-bgColor",
                cssProperty: "background-color"
            }, 
            {
                name: "secondaryFontColor",
                cssSelector: ".office-officeTheme-secondary-fontColor",
                cssProperty: "color"
            }, 
            {
                name: "secondaryBackgroundColor",
                cssSelector: ".office-officeTheme-secondary-bgColor",
                cssProperty: "background-color"
            }
        ];
...
(function (OSF_DDA_Marshaling_ThemingKeys) {
    OSF_DDA_Marshaling_ThemingKeys._map = [];
    OSF_DDA_Marshaling_ThemingKeys.DocumentTheme = 0;
    OSF_DDA_Marshaling_ThemingKeys.OfficeTheme = 1;
    OSF_DDA_Marshaling_ThemingKeys.Background1 = 2;
    OSF_DDA_Marshaling_ThemingKeys.Text1 = 3;
    OSF_DDA_Marshaling_ThemingKeys.Background2 = 4;
    OSF_DDA_Marshaling_ThemingKeys.Text2 = 5;
    OSF_DDA_Marshaling_ThemingKeys.Accent1 = 6;
    OSF_DDA_Marshaling_ThemingKeys.Accent2 = 7;
    OSF_DDA_Marshaling_ThemingKeys.Accent3 = 8;
    OSF_DDA_Marshaling_ThemingKeys.Accent4 = 9;
    OSF_DDA_Marshaling_ThemingKeys.Accent5 = 10;
    OSF_DDA_Marshaling_ThemingKeys.Accent6 = 11;
    OSF_DDA_Marshaling_ThemingKeys.Hyperlink = 12;
    OSF_DDA_Marshaling_ThemingKeys.FollowedHyperlink = 13;
    OSF_DDA_Marshaling_ThemingKeys.HdLatin = 14;
    OSF_DDA_Marshaling_ThemingKeys.HdEastAsian = 15;
    OSF_DDA_Marshaling_ThemingKeys.HdScript = 16;
    OSF_DDA_Marshaling_ThemingKeys.HdLocalized = 17;
    OSF_DDA_Marshaling_ThemingKeys.BdLatin = 18;
    OSF_DDA_Marshaling_ThemingKeys.BdEastAsian = 19;
    OSF_DDA_Marshaling_ThemingKeys.BdScript = 20;
    OSF_DDA_Marshaling_ThemingKeys.BdLocalized = 21;
    OSF_DDA_Marshaling_ThemingKeys.BackgroundColor = 22;
    OSF_DDA_Marshaling_ThemingKeys.PrimaryText = 23;
    OSF_DDA_Marshaling_ThemingKeys.PrimaryBackground = 24;
    OSF_DDA_Marshaling_ThemingKeys.SecondaryText = 25;
    OSF_DDA_Marshaling_ThemingKeys.SecondaryBackground = 26;
...
parameterMap.define({
    ...
    fromHost: [
        {
            name: Microsoft.Office.WebExtension.Parameters.DocumentTheme,
            value: hostKeys.DocumentTheme
        }
    ]
});
parameterMap.define({
    ...
    fromHost: [
        {
            name: Microsoft.Office.WebExtension.Parameters.OfficeTheme,
            value: hostKeys.OfficeTheme
        }
    ]
});
...
parameterMap.define({
    ...
    fromHost: [
        {
            name: destKeys.PrimaryBackgroundColor,
            value: hostKeys.Background1
        }, 
        {
            name: destKeys.PrimaryFontColor,
            value: hostKeys.Text1
        }, 
        {
            name: destKeys.SecondaryBackgroundColor,
            value: hostKeys.Background2
        }, 
        {
            name: destKeys.SecondaryFontColor,
            value: hostKeys.Text2
        }, 
        {
            name: destKeys.Accent1,
            value: hostKeys.Accent1
        }, 
        {
            name: destKeys.Accent2,
            value: hostKeys.Accent2
        }, 
        {
            name: destKeys.Accent3,
            value: hostKeys.Accent3
        }, 
        {
            name: destKeys.Accent4,
            value: hostKeys.Accent4
        }, 
        {
            name: destKeys.Accent5,
            value: hostKeys.Accent5
        }, 
        {
            name: destKeys.Accent6,
            value: hostKeys.Accent6
        }, 
        {
            name: destKeys.Hyperlink,
            value: hostKeys.Hyperlink
        }, 
        {
            name: destKeys.FollowedHyperlink,
            value: hostKeys.FollowedHyperlink
        }, 
        {
            name: destKeys.HeaderLatinFont,
            value: hostKeys.HdLatin
        }, 
        {
            name: destKeys.HeaderEastAsianFont,
            value: hostKeys.HdEastAsian
        }, 
        {
            name: destKeys.HeaderScriptFont,
            value: hostKeys.HdScript
        }, 
        {
            name: destKeys.HeaderLocalizedFont,
            value: hostKeys.HdLocalized
        }, 
        {
            name: destKeys.BodyLatinFont,
            value: hostKeys.BdLatin
        }, 
        {
            name: destKeys.BodyEastAsianFont,
            value: hostKeys.BdEastAsian
        }, 
        {
            name: destKeys.BodyScriptFont,
            value: hostKeys.BdScript
        }, 
        {
            name: destKeys.BodyLocalizedFont,
            value: hostKeys.BdLocalized
        }
    ]
});
...
parameterMap.define({
    ...
    fromHost: [
        {
            name: destKeys.PrimaryFontColor,
            value: hostKeys.PrimaryText
        }, 
        {
            name: destKeys.PrimaryBackgroundColor,
            value: hostKeys.PrimaryBackground
        }, 
        {
            name: destKeys.SecondaryFontColor,
            value: hostKeys.SecondaryText
        }, 
        {
            name: destKeys.SecondaryBackgroundColor,
            value: hostKeys.SecondaryBackground
        }
    ]
});
