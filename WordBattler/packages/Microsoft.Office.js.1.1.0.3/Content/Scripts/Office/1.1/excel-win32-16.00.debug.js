...
(function () {
    ...
    OSF.DDA.AsyncMethodCalls.define({
        ...
        checkCallArgs: function (callArgs, caller, stateInfo) {
            if(callArgs[Microsoft.Office.WebExtension.Parameters.StartRow] == 0 && callArgs[Microsoft.Office.WebExtension.Parameters.StartColumn] == 0 && callArgs[Microsoft.Office.WebExtension.Parameters.CellFormat] == [] && callArgs[Microsoft.Office.WebExtension.Parameters.TableOptions] == []) {
                delete callArgs[Microsoft.Office.WebExtension.Parameters.StartRow];
                delete callArgs[Microsoft.Office.WebExtension.Parameters.StartColumn];
            ...
            if(callArgs[Microsoft.Office.WebExtension.Parameters.CoercionType] != OSF.DDA.DataCoercion.getCoercionDefaultForBinding(caller.type) && ((callArgs[Microsoft.Office.WebExtension.Parameters.StartRow] && callArgs[Microsoft.Office.WebExtension.Parameters.StartRow] != 0) || (callArgs[Microsoft.Office.WebExtension.Parameters.StartColumn] && callArgs[Microsoft.Office.WebExtension.Parameters.StartColumn] != 0) || callArgs[Microsoft.Office.WebExtension.Parameters.CellFormat] || callArgs[Microsoft.Office.WebExtension.Parameters.TableOptions])) {
                throw OSF.DDA.ErrorCodeManager.errorCodes.ooeCoercionTypeNotMatchBinding;
            }
            return callArgs;
        },
...
(function () {
    ...
    var formatProperties = {
        ...
        borderOutlineStyle: {
            text: "borderOutlineStyle",
            type: 211
        },
        borderOutlineColor: {
            text: "borderOutlineColor",
            type: 212
        },
        borderInlineStyle: {
            text: "borderInlineStyle",
            type: 213
        },
        borderInlineColor: {
            text: "borderInlineColor",
            type: 214
        },
        fontFamily: {
            text: "fontFamily",
        ...
        fontStrikethrough: {
            text: "fontStrikethrough",
            type: 307
        },
        fontSuperscript: {
            text: "fontSuperscript",
            type: 308
        },
        fontSubscript: {
            text: "fontSubscript",
