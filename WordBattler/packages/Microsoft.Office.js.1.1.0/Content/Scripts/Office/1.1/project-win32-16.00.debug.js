...
OSF.DDA.AsyncMethodCalls.define({
    ...
    onSucceeded: function (resIdDescriptor) {
        return resIdDescriptor[Microsoft.Office.WebExtension.Parameters.ResourceId];
    }
});
OSF.DDA.AsyncMethodCalls.define({
...
OSF.DDA.SafeArray.Delegate.ParameterMap.define({
    ...
    fromHost: [
        {
            name: Microsoft.Office.WebExtension.Parameters.ServerUrl,
            value: 0
        }, 
        {
            name: Microsoft.Office.WebExtension.Parameters.ListName,
            value: 1
        }
    ]
});
...
OSF.DDA.SafeArray.Delegate.ParameterMap.define({
    ...
    fromHost: [
        {
            name: Microsoft.Office.WebExtension.Parameters.ViewType,
            value: 0
        }, 
        {
            name: Microsoft.Office.WebExtension.Parameters.ViewName,
            value: 1
        }
    ]
});
OSF.DDA.SafeArray.Delegate.ParameterMap.define({
    type: OSF.DDA.EventDispId.dispidTaskSelectionChangedEvent
});
OSF.DDA.SafeArray.Delegate.ParameterMap.define({
    type: OSF.DDA.EventDispId.dispidResourceSelectionChangedEvent
});
OSF.DDA.SafeArray.Delegate.ParameterMap.define({
    type: OSF.DDA.EventDispId.dispidViewSelectionChangedEvent
});
