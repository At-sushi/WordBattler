...
Strings.OfficeOM.L_CannotNavigateTo = "Το αντικείμενο βρίσκεται σε θέση όπου δεν υποστηρίζεται πλοήγηση.";
...
Strings.OfficeOM.L_InvalidFormatValue = "Μία ή περισσότερες από τις παραμέτρους format έχουν τιμές που δεν επιτρέπονται. Επαναλάβετε τον έλεγχο των τιμών και προσπαθήστε ξανά.";
...
Strings.OfficeOM.L_SpecifiedIdNotExist = "Δεν υπάρχει το καθορισμένο αναγνωριστικό.";
