...
Strings.OfficeOM.L_CannotNavigateTo = "El objeto se encuentra en un lugar donde no se admite la navegación.";
...
Strings.OfficeOM.L_InvalidCellsValue = "Uno o más de los parámetros de las celdas tienen valores que no están permitidos. Compruebe de nuevo los valores y vuelva a intentarlo.";
Strings.OfficeOM.L_DataNotMatchBindingType = "El objeto de datos especificado no es compatible con el tipo de enlace.";
Strings.OfficeOM.L_InvalidFormatValue = "Uno o varios parámetros de formato tienen valores que no están permitidos. Compruebe de nuevo los valores y vuelva a intentarlo.";
...
Strings.OfficeOM.L_ElementMissing = "No pudimos dar formato a la celda de la tabla porque faltan algunos valores de parámetro. Compruebe de nuevo los parámetros y vuelva a intentarlo.";
...
Strings.OfficeOM.L_InvalidTableOptionValue = "Uno o varios parámetros tableOptions tienen valores que no están permitidos. Compruebe de nuevo los valores y vuelva a intentarlo.";
